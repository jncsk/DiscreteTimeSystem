 ...
 *
 *  Description:
 *      This header declares the function to compute (Ad, Bd) for a continuous-time
 *      state-space model using the block matrix exponential method under Zero-Order Hold.     *
 * =============================================================================
 */

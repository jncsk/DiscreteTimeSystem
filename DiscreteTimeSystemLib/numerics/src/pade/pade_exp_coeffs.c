...
static const PadeExpTable PADE_EXP_M3 = { 3, PADE3_EVEN, PADE3_ODD, 2, 2 };

/* m=5 split */
static const double PADE5_EVEN[] = { 30240.0, 3360.0, 30.0 };   /* b0,b2,b4 */
static const double PADE5_ODD[] = { 15120.0, 420.0, 1.0 };     /* b1,b3,b5 */
static const PadeExpTable PADE_EXP_M5 = { 5, PADE5_EVEN, PADE5_ODD, 3, 3 };
...
static const PadeExpTable PADE_EXP_M7 = { 7, PADE7_EVEN, PADE7_ODD, 4, 4 };
...
static const PadeExpTable PADE_EXP_M9 = { 9, PADE9_EVEN, PADE9_ODD, 5, 5 };
...
static const PadeExpTable PADE_EXP_M13 = { 13, PADE13_EVEN, PADE13_ODD, 7, 7 };
